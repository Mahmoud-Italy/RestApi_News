...
<head>
  ...
  <link href="{{ url('api/vendor/font-awesome/css/font-awesome.min.css') }}" rel="stylesheet" type="text/css">
...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
          ...
          @include('api/sections/categories')
          @include('api/sections/news')
    ...
    <script src="{{ url('api/vendor/jquery-easing/jquery.easing.min.js') }}"></script>
    <script src="{{ url('api/vendor/datatables/jquery.dataTables.js') }}"></script>
    <script src="{{ url('api/vendor/datatables/dataTables.bootstrap4.js') }}"></script>
    <script src="{{ url('api/js/sb-admin.min.js') }}"></script>
    <script src="{{ url('api/js/sb-admin-datatables.min.js') }}"></script>
